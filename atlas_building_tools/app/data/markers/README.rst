...
an input of the command line `atlas-building-tools cell-densities fit-average-densities`,
see `atlas_building_tools.app.cell_densities`. The gene marker configuration binds
...
only. (Those regions are listed in `atlas_building_tools/app/data/measurements/homogenous_regions.csv`.)


Gene markers configuration files
--------------------------------
The option `--gene-config-path` of the CLI `atlas-building-tools cell-densities fit-average-densities` expects
