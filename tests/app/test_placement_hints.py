...
def test_thalamus():
    ...
    with runner.isolated_filesystem():
        ...
        #
        # The testing issues reported here are very similar to those encountered with CA1 and isocortex below.
        # Renderings of the created surface meshes and of problematic volumes
...
def test_ca1():
    ...
    with runner.isolated_filesystem():
        ...
        with open("placement_hints/distance_report.json") as file_:
            ...
            assert report_before[obtuse_angles] == report_after[obtuse_angles]
            assert report_after[at_least_one_problem] < report_before[at_least_one_problem]

            for description in report_before:
                if description not in [obtuse_angles, at_least_one_problem]:
