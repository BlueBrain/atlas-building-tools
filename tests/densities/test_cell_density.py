...
from atlas_building_tools.densities.utils import get_group_ids, get_region_masks
...
def test_cell_density_options():
    ...
    with patch(
        ...
        with patch(
            ...
            tested.compute_cell_density(region_map, annotation, voxel_volume, nissl, {666: "0.1"})
